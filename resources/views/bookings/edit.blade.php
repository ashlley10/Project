...
<head>
    ...
    <style>
        ...
        .top-bar .actions a {
            background-color:rgb(247, 120, 219);
            color: white;
            padding: 10px 18px;
            border: none;
            border-radius: 6px;
        ...
        .flatpickr-calendar {
            ...
            color: white;
            box-shadow: 0 0 10px rgba(245, 131, 197, 1);
        }
        ...
        .flatpickr-day.endRange {
            background-color:rgb(238, 92, 194) !important;
            color: white !important;
            border-color: #cfee7bff !important;
        }
